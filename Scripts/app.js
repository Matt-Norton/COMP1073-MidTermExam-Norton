...
var travelReport = (function () {
    ...
    function replaceFolegandros() {
        console.log("replaceFolegandros");
        var Folegandros;
    ...
    function replaceAlonissos() {
        console.log("replaceAlonissos");
        var Alonissos;
    ...
    function replaceSpetses() {
        console.log("replaceSpetses");
        var Spetses;
    ...
    function replaceAmorgos() {
        console.log("replaceAmorgos");
        var Amorgos;
    ...
    function replaceSyros() {
        console.log("replaceSyros");
        var Syros;
    ...
    function replaceMilos() {
        console.log("replaceMilos");
        var Milos;
    ...
    function replaceHydra() {
        console.log("replaceHydra");
        var Hydra;
    ...
    function replaceIthaca() {
        console.log("replaceIthaca");
        var Ithaca;
    ...
    function replaceGavdos() {
        console.log("replaceGavdos");
        var Gavdos;
